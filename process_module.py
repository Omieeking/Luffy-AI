# -*- coding: utf-8 -*-
# from remainder import set_reminder, note
...
def process(query):
    ...
    if answer:
        ...
        # elif answer == "i want to play games" or "play games" or "play game" or "open game":
        #     games()
        #     return "senjoy your games"
            ...
            try:
                ...
                # speak = answer + "I am not able to send this email"
        ...
        # CHANGING NAME
            ...
            elif temp is not None:  # Add a check to ensure temp is not None
                update_name(temp)
